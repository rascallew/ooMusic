  ...
  <div class="result-container">
    ...
    <el-tabs v-model="activeIndex">
      ...
      <el-tab-pane label="MV" name="mv">
        <div class="items mv">
          <div v-for="(item,index) in mv" :key="index"  @click="toMV(item.id)" class="item">
            <div class="img-wrap">
              <!-- 封面 -->
      ...
      this.count = res.data.result.songCount
        ...
        for(let i = 0;i<this.playlists.length;i++){
          if(this.playlists[i].playCount>100000){
            this.playlists[i].playCount=this.playlists[i].playCount/10000 +'万'
          }
        }
      }else{
        //保存mv数据
        ...
        for(let i=0;i<this.mv.length;i++){
          ...
          if(this.mv[i].playCount>100000){
            this.mv[i].playCount = parseFloat(this.mv[i].playCount/10000)+'万'
          }
        }
      }
